...
_STORAGE_PY = os.path.join(_WORKTREE, "python", "indexer", "storage.py")
...
_VERSION_HPP = os.path.join(_WORKTREE, "src", "util", "version.hpp")
...
def test_schema_version_is_current():
    ...
    assert storage.SCHEMA_VERSION == 41, (
