...
Covers:
  * schema/version invariants (SCHEMA_VERSION=30, VERSION='0.53.0')
...
def test_schema_version_is_30():
    assert SCHEMA_VERSION == 35, f"Expected 35, got {SCHEMA_VERSION}"


def test_product_version_is_0501():
    from indexer import cli
    assert cli.VERSION == "0.53.0", f"Expected '0.53.0', got {cli.VERSION!r}"
