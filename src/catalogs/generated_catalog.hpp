...
inline constexpr std::array<Relation, 62> kRelations = {{
    {.id = 1,
     ...
     .traversal = "out|in",
     .evidence = "call_site",
     .evidence_capabilities = "call_site|declaration",
    ...
    {.id = 2,
     ...
     .evidence_capabilities = "declaration",
    ...
    {.id = 4,
     ...
     .target = "symbol.template",
     .inverse = "specialized_by",
     .traversal = "out|in",
     .evidence = "declaration",
     .evidence_capabilities = "declaration|reference_site",
     .completeness = "partial",
     .virtual_relation = false},
    {.id = 5,
     .name = "instantiates",
    ...
    {.id = 7,
     ...
     .evidence_capabilities = "reference_site|call_site",
     .completeness = "partial",
     .virtual_relation = false},
    {.id = 8,
     .name = "field_of",
     .layer = View::Symbol,
     .source = "symbol.member",
     .target = "symbol.record",
     .inverse = "fields",
     .traversal = "out|in",
     .evidence = "declaration",
    ...
    {.id = 10,
     ...
     .traversal = "out|in",
     .evidence = "call_site",
     .evidence_capabilities = "call_site",
     .completeness = "partial",
     .virtual_relation = false},
    {.id = 11,
     .name = "construct-temp",
    ...
    {.id = 18,
     ...
     .source = "symbol.callable",
     .target = "symbol.callable",
     .inverse = "dispatch_callers",
     .traversal = "out|in",
     .evidence = "call_site",
     .evidence_capabilities = "call_site|derived",
     .completeness = "partial",
     .virtual_relation = false},
    {.id = 19,
     .name = "alias_of",
    ...
    {.id = 21,
     ...
     .traversal = "out|in",
     .evidence = "declaration",
     .evidence_capabilities = "declaration|call_site",
     .completeness = "complete",
    ...
    {.id = 1,
     .name = "of_type",
     .layer = View::TemplateArgument,
     .source = "template_argument",
     .target = "type",
     .inverse = "has_template_argument",
     .traversal = "out|in",
     .evidence = "reference_site",
     .evidence_capabilities = "reference_site",
     .completeness = "partial",
     .virtual_relation = true},
    {.id = 2,
     .name = "references_symbol",
...
inline constexpr std::array<std::string_view, 6> kStatuses = {
    "complete", "partial", "unknown", "refuted", "conditional", "error"};
inline constexpr std::array<std::string_view, 6> kEvidenceClasses = {
    "source", "derived", "inferred", "runtime", "assumption", "proof"};
inline constexpr std::array<std::string_view, 3> kTrustLevels = {
