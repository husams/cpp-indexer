...
struct SymbolRecord {
  ...
  std::optional<std::string> qual_name = std::nullopt;
  std::optional<std::string> display_name = std::nullopt;
  std::optional<std::string> type_info = std::nullopt;
  ...
  std::optional<int64_t> decl_line =
      std::nullopt; // spelling location; declarations only
  std::optional<int64_t> decl_col = std::nullopt;
  std::optional<std::string> decl_path =
      std::nullopt; // unregistered declaration source
  ...
  std::optional<std::string> const_value =
      std::nullopt;      // v33: evaluated constant initializer
  ...
  std::optional<std::string> identity_source = std::nullopt;
  std::optional<std::string> identity_translation_unit = std::nullopt;
  std::optional<std::string> local_anchor = std::nullopt;
