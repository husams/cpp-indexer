...
def load() -> dict:
    ...
    for key in ("statuses", "exit_classes", "freshness", "completeness_states", "diagnostic_severities", "evidence_classes", "trust_levels", "event_kinds", "diagnostic_codes", "artifact_kinds", "acceptance_vectors"):
        if not data.get(key):
...
def bounded_schema(data: dict) -> dict:
    ...
    defs: dict[str, dict] = {}
    primitive = [text, {"type": "integer"}, {"type": "number"}, {"type": "boolean"}, {"type": "null"}]
...
def render_schema(data: dict) -> dict:
    ...
    schema = {
        ...
        "properties": {
            ...
            "producer": {"type": "object", "required": ["package", "version", "backend", "schema_version"], "additionalProperties": False, "properties": {"package": text, "version": text, "backend": text, "schema_version": {"type": "integer", "minimum": 1}}},
            "completeness": {"type": "object", "required": ["state", "truncated", "stale", "budget"], "additionalProperties": False, "properties": {"state": {"enum": data["completeness_states"]}, "truncated": {"type": "boolean"}, "stale": {"type": "boolean"}, "budget": {"anyOf": [{"type": "integer", "minimum": 0}, {"type": "null"}]}}},
            ...
            "artifacts": {"type": "array", "maxItems": limits["max_artifacts"], "items": {"type": "object", "required": ["kind", "id", "schema_version", "catalog_version", "catalog_hash"], "additionalProperties": False, "properties": {"kind": {"enum": data["artifact_kinds"]}, "id": text, "schema_version": {"type": "integer", "minimum": 1}, "catalog_version": {"type": "integer", "minimum": 1}, "catalog_hash": text}}},
            ...
            "resources": {"type": "object", "required": ["elapsed_ms", "peak_bytes"], "additionalProperties": False, "properties": {"elapsed_ms": {"anyOf": [{"type": "integer", "minimum": 0}, {"type": "null"}]}, "peak_bytes": {"anyOf": [{"type": "integer", "minimum": 0}, {"type": "null"}]}}},
        },
    }
