...
run_model() {
  ...
  local cfg="$ROOT/models/${model}.cfg"
...
run_model CidxRepositorySmoke "TypeInvariant,RepositoryStructureInvariant,SharedStatusInvariant,ProtectedInvariant"
run_model CidxResultSmoke "SharedResultTypeInvariant,SharedStatusInvariant,TrustedOutcomeInvariant"
